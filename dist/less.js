...
colorFunctions = {
	'const': function(nameDescr, valueDescr)
	{
		...
		var _storedConsts = global._storedConsts = global._storedConsts || {};

		if (valueDescr === undefined)
		{
			value = _storedConsts[nameDescr.value];
			if (value === undefined)
			{
			...
			{
				return new (Color)(value.slice(1));
			}
			else if (isNaN(value))
			{
		...
		{
			_storedConsts[nameDescr.value] = valueDescr.value;
...
},{"../tree/anonymous":46,"../tree/color":50,"../tree/dimension":56,"../tree/quoted":73,"../tree/value":81,"./function-registry":22}],19:[function(require,module,exports){
        ...
        parsers: parsers = {
            ...
            primary: function () {
                ...
                while (true) {
                    ...
                    node = mixin.definition() || this.rule() || this.entities.call() || this.ruleset() ||
